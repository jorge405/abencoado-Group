        ...
        <div class=" bg-gray-50 bg-opacity-80  ml-56 w-3xl p-6 rounded-lg shadow-2xl flex flex-col space-x-2">
            ...
            <form @submit.prevent="envioForm">
                    <div class="grid grid-cols-2 gap-x-5">
                        <div class="flex flex-col mt-5">
                            <label class=" text-sm font-Nunito text-slate-900 mb-2">Nombre de Cuenta</label>     
                            <input :value="itemSeleccionado.nombre_cuenta"  type="text" class=" w-xs rounded-xl border border-gray-300 p-2 placeholder:text-sm placeholder:text-slate-900 focus:border-sky-300 focus:outline-hidden focus:ring-3 focus:ring-sky-400/10 text-slate-900  " placeholder=" Ingrese nombre de cuenta">
                        </div>
                        <div class="flex flex-col mt-5 justify-center">
                            <label class=" text-sm font-Nunito text-slate-900 mb-2">Puct</label>     
                            <input :value="itemSeleccionado.puct"  type="text" class=" w-xs rounded-xl border border-gray-300 p-2 placeholder:text-sm placeholder:text-slate-900 focus:border-sky-300 focus:outline-hidden focus:ring-3 focus:ring-sky-400/10 text-slate-900  " placeholder=" Puct">
                        </div>
                    </div>
                    <div class="grid grid-cols-2 gap-x-5">
                        <div class="flex flex-col mt-5">
                            <label class=" text-sm font-Nunito text-slate-900 mb-2">Tipo</label>     
                            <p class=" text-slate-900 text-md font-Nutito">{{ itemSeleccionado.cod_tpcuenta===1 ? 'ACTIVO': itemSeleccionado.cod_tpcuenta===2 ? 'PASIVO' : itemSeleccionado.cod_tpcuenta===3 ? 'CAPITAL' : itemSeleccionado.cod_tpcuenta===4 ? 'INGRESO' : 'GASTO' }}</p>
                        </div>
                        <div class="flex flex-col mt-5">
                            <label class=" text-sm font-Nunito text-slate-900 mb-2">Nivel</label>     
                            <p class=" text-slate-900 text-md font-Nutito">{{ itemSeleccionado.cod_nivelCuenta }}</p>
                        </div>
                    </div>
                    <div class="grid grid-cols-2 gap-x-5">
                        <div class="flex flex-col mt-5 justify-center">
