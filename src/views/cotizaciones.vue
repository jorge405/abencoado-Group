...
export default{
    ...
    methods:{
        ...
        async guardarCotizaciones(){
            ...
            try {
                const response = await api.post('/addCotizacion',this.rowData);
        ...
        async infoCotizaciones(){
                try {
                    ...
                    const responseCotizaciones = await api.get(`/getCotizaciones/${this.selectedGestion}`);
...
<sidebar>
    ...
    <div class=" flex flex-col">
        <div class=" flex flex-row space-x-5">
            ...
            <select v-model="selectedGestion" class=" p-2 w-xs border border-gray-200 rounded-xl placeholder:text-sm focus:border-sky-300 focus:outline-hidden focus:ring-3 focus:ring-sky-400/10 " >
        ...
        <div class=" flex flex-row space-x-10 ml-50 mt-5">
            ...
            <button  v-show="false" class=" cursor-pointer p-2 bg-red-500 rounded-lg text-white font-Nunito flex flex-row ">Eliminar <span class=" ml-3"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path fill="#fff" d="M20 6a1 1 0 0 1 .117 1.993L20 8h-.081L19 19a3 3 0 0 1-2.824 2.995L16 22H8c-1.598 0-2.904-1.249-2.992-2.75l-.005-.167L4.08 8H4a1 1 0 0 1-.117-1.993L4 6zm-6-4a2 2 0 0 1 2 2a1 1 0 0 1-1.993.117L14 4h-4l-.007.117A1 1 0 0 1 8 4a2 2 0 0 1 1.85-1.995L10 2z"/></svg></span></button>
        </div>
    </div>
</sidebar>
